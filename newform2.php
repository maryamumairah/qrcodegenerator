...
<head>
    ...
    <title>New Form 2</title>
    <link rel="stylesheet" href="newstyles2.css">
</head>
<body>
    <div class="container">
        ...
        <form action="newqrcode2.php" method="post">
            ...
            <div class="product-type-container">
                ...
                <div class="radio-group">
                    <label>
                        <input type="radio" name="productType" value="electrical" required onclick="showForm()"> Electrical
                    </label>
                    <label>
                        <input type="radio" name="productType" value="oil" required onclick="showForm()"> Oil
                    </label>
                </div>
            </div>
            ...
            <div id="formContainer" style="display: none;">
                ...
                <div class="serial-parent-container">
                    <div class="serial-inputs">
                        <div class="input-group">
                            <label for="startNumber">Start Running Number<span class="required">*</span></label>
                            <input type="number" id="startNumber" name="startNumber" min="0" max="9999999" placeholder="0-9999999">
                        </div>
                        <span></span>
                        <div class="input-group">
                            <label for="endNumber">Range<span class="required">*</span></label>
